...
def run_tests(test_cases, test_case_generator, exe_paths, names):
    for name, exe_path in zip(names, exe_paths):
        if not os.path.exists(f'C:/Users/pc/Desktop/test/random_square/{name}'):
            os.makedirs(f'C:/Users/pc/Desktop/test/random_square/{name}')
        if os.path.exists(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}'):
            shutil.rmtree(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}')
        os.makedirs(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}')

        result_dir = f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}'
        ...
        for i, (widths, heights, strip_width) in enumerate(test_cases):
            ...
            dir_path = os.path.join(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}', f'test_case_{len(widths)}')
        ...
        plt.grid(True)
        plt.savefig(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}/execution_times.png')
        plt.close()
        ...
        plt.grid(True)
        plt.savefig(f'C:/Users/pc/Desktop/test/random_square/{name}/test_cases_{test_case_name}/approx_ratios.png')
        plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'C:/Users/pc/Desktop/test/random_square/execution_times_comparison.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'C:/Users/pc/Desktop/test/random_square/approx_ratios_comparison.png')
    plt.close()

exe_paths = ["C:/Users/pc/Desktop/test/FFDH.exe", "C:/Users/pc/Desktop/test/NFDH.exe", "C:/Users/pc/Desktop/test/Sleator.exe", "C:/Users/pc/Desktop/test/SP.exe"]
names = ["FFDH", "NFDH", "Sleator", "SP"]

test_case_index = 1
test_case_generator = test_case_generators[test_case_index]
test_case_name = test_case_names[test_case_index]

test_cases = [test_case_generator(n) for n in np.arange(10, 10011, 1000)]
